function [classifier, hogFeatureSize] = trainClassifierEDGE(z)
...
function [trainingSet, hogFeatureSize]= getTrainingImages(cellSizeFrontZones, ...
    ...
    for i = 1:3
        trainingSetDir = fullfile(strcat('TrainingPictures\Track',num2str(i)));      
    ...
    for i = 1:3
       ...
       img = edge(rgb2gray(imcrop(read(trainingSet{i}(1), 4), z{:,i})),'canny',.25);
